...
# Interactive
#
# This is the code of nh5 but without type declarations of variables 
...
f(x, y, z) = x^4 + y^4/16.0 + z^4/81.0 - 1.0

# coordinates of normal vector field
v1(x, y, z) = 4.0*x^3
v2(x, y, z) = y^3/4.0
v3(x, y, z) = 4.0*z^3/9.0
...
function umbilic_points(a, b, c, N::Int64, eps,  eps1)
         surface_points = [ ]
         umbilic_points = [ ]                                                                                                                                                  
